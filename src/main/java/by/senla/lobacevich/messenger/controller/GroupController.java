...
public class GroupController {
    ...
    @PostMapping
    public DetailedGroupDtoResponse createEntity(@Valid @RequestBody GroupDtoRequest dtoRequest) throws EntityNotFoundException, InvalidDataException, AccessDeniedException {
