...
public class ChatController {
    ...
    @PostMapping
    public DetailedChatDtoResponse createEntity(@Valid @RequestBody ChatDtoRequest dtoRequest) throws EntityNotFoundException, InvalidDataException, AccessDeniedException {
